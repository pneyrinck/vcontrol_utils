...
public:
    TestModule(const char * identifier, const char * vendor, const char * name, VControlModule *parent){
        ...
        VControlModuleSendValue(module, index, kVControlProperty_DefaultValue, 0.5);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 1");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeContinuous);

        VControlModuleAddControl(module, index, "param2", kVControlParameterTypeBoolean);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 2");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeBoolean);
        
        VControlModuleAddControl(module, index, "param3", kVControlParameterTypeIndexed);
        VControlModuleSendValue(module, index, kVControlProperty_NumberOfSteps, 5);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 3");
        paramValues.add(0);
        paramMax.add(4);
        paramType.add(kVControlParameterTypeIndexed);
        
        VControlModuleAddControl(module, index, "param4", kVControlParameterTypeMomentary);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 4");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeMomentary);
        
        VControlModuleAddControl(module, index, "param5", kVControlParameterTypeBoolean);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 5");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeBoolean);
        
        VControlModuleAddControl(module, index, "param6", kVControlParameterTypeContinuous);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 6");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeContinuous);

        VControlModuleAddControl(module, index, "param7", kVControlParameterTypeContinuous);
        VControlModuleSendValue(module, index++, kVControlProperty_Name, "Parameter 7");
        paramValues.add(0);
        paramMax.add(1);
        paramType.add(kVControlParameterTypeContinuous);
